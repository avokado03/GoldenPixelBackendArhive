...
{
	internal static class OrdersValidator
	{
		internal static ValidationResult VadidateGetOrderByIdRequest(GetOrderByIdRequest request)
		{
		...
		internal static ValidationResult ValidateGetOrdersRequest(GetOrdersRequest request)
		{
			throw new NotImplementedException();
		}

		internal static ValidationResult ValidateCreateOrderCommand(CreateOrderCommand command)
		{
